class ProjectsController < ApplicationController
    ...
    def my_activity
    	...
    	my_projects.each do |project|
    		return_object << {id: project.id , message: "You donation form #{project.id} is under review", created_at: "#{project.created_at.to_date} #{{project.created_at.strftime("%I:%M%p")}}"}
    	end	
